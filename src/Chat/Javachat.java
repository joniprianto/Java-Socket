...
public class Javachat extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        setTitle("JONI PRIANTO JAVA SOCKET");
    ...
    private void Namauserfocusgained(java.awt.event.FocusEvent evt) {                                        
        
        if(txtUsername.getText().trim().toLowerCase().equals("Nama user")){
            txtUsername.setText("");
            txtUsername.setForeground(Color.BLACK);
        }
        }
    
      private void NamauserFocusLost(java.awt.event.FocusEvent evt) {                                      
      
        if(txtUsername.getText().trim().equals("") || txtUsername.getText().trim().toLowerCase().equals("Nama user")){
            txtUsername.setText("Nama user");
